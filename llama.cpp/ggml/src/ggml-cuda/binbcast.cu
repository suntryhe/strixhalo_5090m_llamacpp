...
static void ggml_cuda_op_bin_bcast(
    ...
    if (src0->type == GGML_TYPE_F32 && dst->type == GGML_TYPE_F32) {
        ...
        // I32 REPEAT (MoE remap tables): op_repeat is a pure copy, safe for indices
